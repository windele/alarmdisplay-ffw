...
$result = $db->query("SELECT rw,hw FROM tbl_einsaetze ORDER BY id DESC LIMIT 1");
...
<body>
  <iframe src='https://geoportal.bayern.de/bayernatlas/embed.html?N=<?php echo $hw."&E=".$rw." &zoom=". $parameter['ZOOMGROSS'] ."&lang=de&topic=ba&bgLayer=". $parameter['LAYERGROSS'] ?>&crosshair=marker&catalogNodes=122' width='1920' height='1080' frameborder='0' style='border:0'>Kartendarstellung</iframe>Karte
