...
Achtung: Ab FritzOS 7.20 wird die SMB-Version 1.0 nicht mehr standardmäßig von der FritzBox unterstützt. Entweder die Zeile so lassen und das SMBv1 Protokoll wieder in der FritzBox einschalten, oder den Zusatz ",vers=1.0" bei obiger Zeile weglassen.
