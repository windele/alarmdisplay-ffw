...
--
-- Host: localhost:3306
-- Erstellungszeit: 05. Mai 2019 um 00:19
...
--
CREATE DATABASE IF NOT EXISTS `alarmdisplay` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `alarmdisplay`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Speicherort der Einstellungen für das Alarmdisplay';
...
(18, 'MAPZOOMOBEN', '14', 'text', 2, 3, 1, 'Zoomlevel Karte oben', 'Wie groß soll die Karte bei Einsätzen im oberen Fenster vergrößert werden? Angabe in Zahlen.'),
(97, 'PROWLENABLED', 'false', 'boolean', 2, 10, 1, 'Anbindung an Prowl aktivieren?', 'Soll die Anbindung an Prowl aktiviert werden?'),
(19, 'LAYERKARTEOBEN', 'luftbild_labels', 'text', 2, 3, 2, 'Kartentyp obere Karte', 'Welcher Kartentyp soll in der oberen Karte dargestellt werden? Werte sind \'atkis\', \'atkis_sw\', \'luftbild_labels\' oder \'tk\'-'),
(20, 'MAPZOOMUNTEN', '13', 'text', 2, 3, 3, 'Zoomlevel Karte im unteren Fenster', 'Wie groß soll die Karte bei Einsätzen im unteren Fenster vergrößert werden? Angabe in Zahlen.'),
(21, 'LAYERKARTEUNTEN', 'atkis', 'text', 2, 3, 4, 'Kartentyp untere Karte', 'Welcher Kartentyp soll in der unteren Karte dargestellt werden? Werte sind \'atkis\', \'atkis_sw\', \'luftbild_labels\' oder \'tk\'-'),
(22, NULL, NULL, NULL, 2, 3, 0, 'Kartendarstellung Zoomlevel', 'Hier können Sie die Parameter zur Kartendarstellung der Einsatzkarten im BayernAtlas einstellen.'),
...
(47, NULL, NULL, NULL, 2, 9, 0, 'x Externer Alarm: Anbindung an Divera', 'Das  Display kann an Divera247.com angebunden werden. '),
(94, 'DIVERAENABLED', 'false', 'boolean', 2, 9, 1, 'Anbindung an Divera aktivieren?', 'Soll die Anbindung an Divera247.com aktiviert werden?'),
...
(52, 'HINWEISTEXTBIS1', '2019-11-11 16:45', 'date', 4, 2, 3, 'Anzeigen bis', 'Bis wann soll der Text angezeigt werden? Eingabe in folgendem Muster:  \"2012-12-01 12:00\" -> YYYY-MM-DD HH-MM'),
...
(59, NULL, NULL, NULL, 2, 5, 0, 'x Externer Alarm: SMS-Funktion', 'Das Alarmdisplay kann bei Faxeingang SMS verschicken. Einzelheiten dazu können hier eingestellt werden.'),
(60, 'SMSENABLED', 'false', 'boolean', 2, 5, 1, 'SMS-Funktion aktiv? ', 'Soll die SMS-Funktion aktiviert sein? Die SMS-Funktion wird über den Dienstleister Rettalarm abgewickelt und benötigt dort eine Registrierung. Durch den SMS-Versand entstehen Kosten; eine Abrechnung erfolgt durch Rettalarm.'),
(61, 'SMSUSER', 'feuerwehr.musterstadt', 'text', 2, 5, 3, 'Username', 'Zugang für den SMS-Provider'),
(62, 'SMSPASS', '', 'password', 2, 5, 4, 'Passwort', 'Zugang für den SMS-Provider (ePass-Hash)'),
...
(66, 'SMTPSERVER', 'smtp.provider.de', 'text', 2, 6, 6, 'SMTP-Server', 'Geben Sie hier Ihren SMTP-Server an, über den die Mail verschickt wird.'),
...
(68, 'SMTPPASS', 'alarm!sirene!geht', 'password', 2, 6, 8, 'Passwort für SMTP', 'Geben Sie hier Ihr Passwort für den SMTP-Server ein.'),
...
(70, 'SMSALARMGRUPPEN', '', 'text', 2, 5, 2, 'Per SMS zu alarmierende Gruppen/Listen', 'Tragen Sie hier die Gruppen und Listen ein, die über das SMS-System zu alarmieren sind. Vor die GID ist ein Plus-Zeichen zu setzen. Befragen Sie bei Unsicherheiten den Adminstrator oder das Rettalarm-Handbuch.'),
...
(74, 'DRUCKENSCREENWIEOFT', '1', 'text', 2, 7, 2, 'Wieviele Exemplare?', 'Wieviele Exemplare sollen gedruckt werden?'),
(75, 'DRUCKENFAX', 'false', 'boolean', 2, 7, 3, 'Originalfax auch ausdrucken?', 'Soll das Originalfax  ausgedruckt werden? Funktion unabhängig vom Ausdruck des Screenshots.'),
(76, 'DRUCKENFAXWIEOFT', '1', 'text', 2, 7, 4, 'Exemplare Originalfax?', 'Wieviele Exemplare des Originalfaxes sollen gedruckt werden?'),
...
(92, 'LAYERGROSS', 'atkis', 'text', 2, 3, 6, 'Layerdarstellung der Übersichtskarte', 'Welcher Kartenlayer soll auf der Übersichtskarte dargestellt werden?'),
...
(83, 'UHRBACKGROUND', 'true', 'boolean', 3, 1, 3, 'Hintergrundbild anzeigen?', 'Soll das hochgeladene Hintergrundbild im Uhrzeitmodul verwendet werden?'),
...
(95, 'DIVERAKEY', 'accesskeyvondivera', 'password', 2, 9, 2, 'Access Key', 'Tragen Sie hier den Access-Key von Divera ein.'),
(88, 'DRUCKENANFAHRT', 'true', 'boolean', 2, 3, 5, 'Übersichtskarte drucken?', 'Soll auf dem Ausdruck eine große Übersichtskarte gedruckt werden?'),
(89, 'ZOOMGROSS', '12', 'text', 2, 3, 6, 'Zoomlevel Übersichtskarte', 'Zoomlevel der Übersichtskarte, Werte von 1-15'),
(96, NULL, NULL, NULL, 2, 10, 0, 'x Externer Alarm: Anbindung an Prowl', 'Das  Display kann an Prowl angebunden werden. '),
(98, 'PROWLKEY', 'accesskey', 'password', 2, 10, 2, 'API-Key', 'Tragen Sie hier den Api-Key von Prowl ein.'),
(99, NULL, NULL, NULL, 2, 11, 0, 'x Externer Alarm: Anbindung an Telegram', 'Das  Display kann an Telegram angebunden werden. '),
(100, 'TELEGRAMENABLED', 'false', 'boolean', 2, 11, 1, 'Anbindung an Telegram aktivieren?', 'Soll die Anbindung an Telegram aktiviert werden?'),
(101, 'TELEGRAMBOTTOKEN', 'accesskey', 'password', 2, 11, 2, 'Bot-Token', 'Tragen Sie hier den Bot-Token von Telegram ein.'),
(102, 'TELEGRAMCHATID', 'accesskey', 'password', 2, 11, 3, 'Chat-ID', 'Tragen Sie hier die Chat-ID von Telegram ein.');
...
CREATE TABLE `tbl_einsaetze` (
  ...
  `mitteiler` text COLLATE utf8_unicode_ci,
  `strasse` text COLLATE utf8_unicode_ci,
  `hausnr` text COLLATE utf8_unicode_ci,
  ...
  `hw` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Hochwert'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabelle für Einsatzdaten Alarmdisplay Feuerwehr Piflas';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='FMS-Statustabelle';
...
(1, 'RW 1', 2, '', '2013-12-22 05:26:13', 'Fzg'),
(2, 'TLF 16/25', 2, '', '2013-12-22 05:23:52', 'Fzg'),
(3, 'LF 8/6', 2, '', '2013-12-21 20:52:53', 'Fzg'),
(4, 'MZF', 2, '', '2013-12-03 15:55:38', 'Fzg');
...
--
-- Indizes für die Tabelle `tbl_adm_params`
--
ALTER TABLE `tbl_adm_params`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `tbl_alarm_user`
--
ALTER TABLE `tbl_alarm_user`
  ADD PRIMARY KEY (`id`);
...
--
-- Indizes für die Tabelle `tbl_fms`
--
ALTER TABLE `tbl_fms`
  ADD PRIMARY KEY (`fzgid`);
...
--
-- AUTO_INCREMENT für Tabelle `tbl_adm_params`
--
ALTER TABLE `tbl_adm_params`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
--
-- AUTO_INCREMENT für Tabelle `tbl_alarm_user`
--
ALTER TABLE `tbl_alarm_user`
...
--
-- AUTO_INCREMENT für Tabelle `tbl_fms`
--
ALTER TABLE `tbl_fms`
  MODIFY `fzgid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
