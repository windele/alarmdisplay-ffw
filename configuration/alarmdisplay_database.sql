...
REPLACE INTO `tbl_adm_params` (`id`, `parameter`, `wert`, `type`, `tab`, `acc`, `line`, `title`, `beschreibung`) VALUES
	...
	(48, 'SMTPSENDER', 'Feuerwehr Musterstadt', 'text', 2, 6, 3, 'Absender der E-Mail', 'Geben Sie hier den Absendernamen der E-Mail ein. '),
	...
	(66, 'SMTPSERVER', 'smtp.musterserver.de', 'text', 2, 6, 5, 'SMTP-Server', 'Geben Sie hier Ihren SMTP-Server an, über den die Mail verschickt wird.'),
	(67, 'SMTPUSER', 'alarm@feuerwehr-musterstadt.de', 'text', 2, 6, 6, 'Username für SMTP', 'Geben Sie hier den Usernamen zur Anmeldung am SMTP-Server ein.'),
	(68, 'SMTPPASS', 'alarm!sirenegeht', 'password', 2, 6, 7, 'Passwort für SMTP', 'Geben Sie hier Ihr Passwort für den SMTP-Server ein.'),
	(69, 'SMTPSENDERMAIL', 'alarm@feuerwehr-musterstadt.de', 'text', 2, 6, 4, 'Absendermail-Adresse', 'Von welcher E-Mail-Adresse soll die Mail abgesendet werden? Diese Adresse erhält ebenfalls automatisch eine Kopie der Alarm-E-Mail.'),
	...
	(84, 'SMTPPORT', '587', 'text', 2, 6, 8, 'SMTP-Port Ihres Mail-Servers', 'Geben Sie hier den Port Ihres Mail-Servers ein, z.B. \'587\' für TLS'),
	(85, 'SMTPSECURE', 'tls', 'text', 2, 6, 9, 'E-Mail-Sicherheit', 'Geben Sie hier die Sicherheitsstufe für den SMTP-Server ein: Möglich Eingaben sind \'\' (leer für keine), \'ssl\' und \'tls\''),
